...
registerBlockType( 'kenzap/calendar-1', {
	...
	save: function( props ) {
		return (
			<div>
				<p>{ __( 'Kenzap Calendar 1', 'kenzap-calendar' ) }</p>
			</div>
		);
	},
} );
